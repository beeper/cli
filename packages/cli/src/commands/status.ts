...
export default class Status extends BeeperCommand {
  static override summary = 'Show selected target and setup readiness'
  static override description = 'Read-only readiness snapshot for the selected target. For active reachability checks and diagnostics, run `beeper doctor`.'
