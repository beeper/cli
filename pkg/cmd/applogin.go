...
var appLoginEmail = cli.Command{
	Name:    "email",
	Usage:   "Send a sign-in code to the user email address.",
	Suggest: true,
	Flags: []cli.Flag{
		...
		&requestflag.Flag[string]{
			Name:     "request",
			Usage:    "Login request ID returned by the start step.",
			Required: true,
			BodyPath: "request",
		},
	},
...
var appLoginRegister = cli.Command{
	...
	Flags: []cli.Flag{
		&requestflag.Flag[bool]{
			Name:     "accept-terms",
			Usage:    "Confirms that the user accepted the Terms of Use and acknowledged the Privacy Policy.",
			Required: true,
...
var appLoginResponse = cli.Command{
	Name:    "response",
	Usage:   "Finish sign-in with the code sent to the user email address. If the user needs a\nnew account, the response includes account creation copy and username\nsuggestions.",
	Suggest: true,
	Flags: []cli.Flag{
		&requestflag.Flag[string]{
			Name:     "request",
...
var appLoginStart = cli.Command{
	Name:            "start",
	Usage:           "Start a first-party Beeper Desktop sign-in session.",
	Suggest:         true,
	Flags:           []cli.Flag{},
...
func handleAppLoginEmail(ctx context.Context, cmd *cli.Command) error {
	...
	_, err = client.App.Login.Email(ctx, params, options...)
	if err != nil {
		return err
	}
